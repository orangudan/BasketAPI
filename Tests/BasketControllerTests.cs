...
namespace Tests
{
    ...
    public class BasketControllerTests
    {
        ...
        public void Set_up_controller()
        {
            ...
            _controller =  new BasketController(new InMemoryBasketQuery(baskets), new InMemoryBasketAdder(Guid.Parse(TestId)));
        }

        [Test]
        public void get_returns_not_found_if_basket_missing()
        {
            var result = _controller.Get(Guid.Parse(NotFoundBasketId));
        ...
        {
            var result = _controller.Get(Guid.Parse(FoundBasketId));
